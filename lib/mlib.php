        ...
        self::set('htptemp', '<!DOCTYPE html>' . "\n" .
            tg('html', 'lang="cs"',
                ...
                tg('body', 'style="padding-top: 3.5rem;"',
                    tg('nav', 'class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"',
 ...
 * @param bool $html default true: input data is converted whith htmlspecialchars function, 
 *                           false means raw data
