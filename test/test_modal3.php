...
class Myform extends M5{
 ...
 static function ajax(){
   ...
   /* test output value */
   foreach (['583391'=>'Modřice','598267'=>'Modletice','554197'=>'Branka','535290'=>'Vojkovice'] as $k=>$v) 
     htpr(tg('button',' type="button" class="ret-value btn btn-info mt-3" value="'.$k.'"',$v),br());
   ...
   htpr(tg('script','type="text/javascript"',
    ...
    function(){
       ...
       '$.ajax({url:"'.$url.'?id="'.'+this.value'.','."\n".
           'success: function(result){ '."\n".
           "$('.basicAutoSelect".getpar('name')."').autoComplete('set', { value: this.value, text: result['text'] });"."\n".
        '}});'.
     " });"
